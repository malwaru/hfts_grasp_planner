...
ImgGraphSearch::ImgGraphSearch(const std::experimental::filesystem::path& root_path, const Config& start,
...
void ImgGraphSearch::addWaypoints(const std::vector<Config>& configs)
{
