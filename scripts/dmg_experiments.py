...
if __name__ == "__main__":
    ...
    env.Load(model_folder + "robots/yumi/yumi.xml")
    ...
    obj_names = ['cabinet', 'expo', 'cracker_box', 'mustard', 'elmers_glue', 'sugar_box']
    tf_synch = ros_bridge.TFSynchronizer(env, obj_names, model_folder + 'objects', 'yumi_base_link', robot.GetTransform())
    tf_synch.start()
