...
ENV_FILE = PKG_PATH + "models/environments/test_env_r850_sdh.xml"
...
if __name__ == "__main__":
    object_name = 'crayola'
    planner = IntegratedHFTSPlanner(env_file=ENV_FILE,
                                    hand_file=HAND_FILE,
                                    ...
                                    b_visualize_system=True,
                                    b_visualize_grasps=False,
                                    b_show_search_tree=True,
                                    b_show_traj=True,
