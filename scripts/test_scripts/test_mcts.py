...
if __name__ == "__main__":
    ...
    mcts_sampler = mcts_sampler_mod.MCTSPlacementSampler(hierarchy, hierarchy, hierarchy, hierarchy, ["fake_manip"],
                                                         c=0.5, debug_visualizer=mcts_visualizer)
    mcts_solutions, mcts_num_solutions = mcts_sampler.sample(100000, 100000)
    ...
    # rnd_solutions, rnd_num_solutions = random_sampler.sample(100000, 100000)
